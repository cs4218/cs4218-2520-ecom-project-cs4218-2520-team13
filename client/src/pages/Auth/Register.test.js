...
window.matchMedia = window.matchMedia || function() { // Check for responsive components CSS
    return {
      matches: false,
...
describe('Register Component', () => {
  ...
  it('should register the user successfully', async () => {
    ...
    const { getByText, getByPlaceholderText } = render(   // getByText for buttons, getByPlaceholderText for input fields
    ...
    // fireEvent.change to simulate user input
    ...
    // Assertions to check if the axios.post was called and toast.success was shown
    await waitFor(() => expect(axios.post).toHaveBeenCalled());
    expect(toast.success).toHaveBeenCalledWith('Register Successfully, please login');
  });

  it('should display error message when success is false (else branch)', async () => {
